...
@cache
def find_attention_slice_sizes(
    query_shape, query_element_size, query_device_type, slice_size=None
):
        ...
        for i in range(batch_size_attention // split_slice_size):
            ...
            if do_split_2:
                for i2 in range(
                    ...
                    if do_split_3:
                        for i3 in range(
                            shape_three // split_3_slice_size
                        ):  # pylint: disable=invalid-name
